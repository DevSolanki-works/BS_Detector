...
# IMPORTANT: Any literal { } inside the system prompt must be doubled to {{ }}
# because LangChain's ChatPromptTemplate treats single braces as variables.
# ─────────────────────────────────────────────────────────────────────────────
...
10. FORCE MAJEURE ABUSE — company's obligations disappear but yours do not.
